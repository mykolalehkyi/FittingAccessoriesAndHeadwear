...
import {RGBELoader} from "./three.js-r132/examples/jsm/loaders/RGBELoader.js";
...
export const loadTexture = (path):any => {
  return new Promise((resolve, reject) => {
...
export const loadRGBE = (path):any => {
	return new Promise<any>((resolve, reject) => {
		const loader = new RGBELoader();
		loader.load(path, (rgbe) => {
		resolve(rgbe);
		});
	});
}